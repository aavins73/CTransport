...
namespace LocationSearchRoute
{
       public sealed partial class MainPage : Page
    {
        SQLiteAsyncConnection conn = new SQLiteAsyncConnection("ABC.sqlite");
        ...
        public MainPage()
        {
           ...
           /* checkdbaysnc(conn.ToString());
            ...
            newroute.Add(new LocationSearchRte() { RouteNo = "G03", BoardLocation = "   ", BoardTime = "08:40 AM", EndLocation = "GMR", DropTime = "09:00 AM" });
